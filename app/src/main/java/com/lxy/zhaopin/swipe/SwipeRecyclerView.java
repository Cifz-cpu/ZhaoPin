...
import com.lxy.zhaopin.swipe.footerView.SimpleFooterView;
...
public class SwipeRecyclerView extends FrameLayout
    ...
    private SimpleFooterView mFootView;
     ...
     */
    public void setFooterView(SimpleFooterView footerView){
        if(footerView != null) {
    ...
    public void setFootTextColor(int color){
        mFootView.setFootTextColor(color);
    }
}
